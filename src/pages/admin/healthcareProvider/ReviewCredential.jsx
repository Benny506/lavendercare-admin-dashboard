  ...
  return (
    <div className="pt-6 min-h-screen">
      ...
      <div className="flex items-center gap-1">
        ...
        <p className="text-(--primary-500) font-[600] text-[12px]">Review credentials</p>
      </div>
      ...
      {showModal && selectedProvider && (
        <div className="fixed inset-0 z-[4000] flex items-center justify-center bg-black/80 px-2">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-8 w-full overflow-y-auto max-w-lg mx-auto relative">
            <button
              className="absolute left-4 top-4 text-purple-600 font-semibold flex items-center gap-1"
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-6">
              <button className="bg-red-600 text-white px-6 py-2 rounded-full font-semibold w-full sm:w-1/2">
                Reject
              </button>
              <button className="bg-purple-600 text-white px-6 py-2 rounded-full font-semibold w-full sm:w-1/2">
                Accept
              </button>
            </div>
          </div>
