...
const resources = [
    { name: 'The Benefits of Regular Exercise', type: 'PDF', status: 'Published' },
    { name: 'Understanding Mental Wellness', type: 'PDF', status: 'Published' },
    { name: 'Healthy Eating Habits for a Balanced Life', type: 'Video', status: 'Published' },
    ...
    return (
        <div className="w-full px-2 md:px-8 py-6">
            ...
            <div className="flex items-center gap-1 mb-4">
                ...
                <span className="text-xs text-(--primary-500) font-semibold">Educational Resources</span>
            </div>

            <h2 className="text-xl md:text-2xl font-bold mb-2">Manage Resources</h2>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4">
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full text-sm">
                        ...
                        <tbody>
                            {resources.map((r, idx) => (
                                <tr key={r.name} className="border-b last:border-b-0 hover:bg-gray-50">
                                    <td className="py-2 px-2">{r.name}</td>
                                    <td className="py-2 px-2">{r.type}</td>
                                    <td className="py-2 px-2">
                                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${r.status === 'Published' ? 'bg-green-100 text-green-600' : 'bg-yellow-100 text-yellow-600'}`}>{r.status}</span>
                                    </td>
