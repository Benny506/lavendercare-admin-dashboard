...
const sidebarMenu = [
  ...
  },
  {
    ...
    Icon: ({ size, color }) => (
      <Icons name={"healthcareProviders"} size={size} color={color} />
    ),
  ...
  },
  {
    title: "Content",
    Icon: ({ size, color }) => (
      <Icons name={"content"} size={size} color={color} />
    ),
    path: "/admin/content",
    submenu: [
  ...
  },
  {
    title: "Marketplace",
    Icon: ({ size, color }) => (
      <Icons name={"marketPlace"} size={size} color={color} />
    ),
  ...
  },
  {
    ...
    Icon: ({ size, color }) => (
      <Icons name={"orderAndTransaction"} size={size} color={color} />
    ),
    path: "/admin/order",
    submenu: [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        title: "Provider and Vendor",
        path: "/admin/analytics/provider-and-vendors",
      },
      {
