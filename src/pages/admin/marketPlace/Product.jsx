  ...
  return (
    <div className="w-full px-2 md:px-8 py-6">
      ...
      <div className="flex items-center gap-1 mb-4">
        ...
        <span className="text-xs text-gray-400">Manage Product</span>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-2">
        ...
        <button
          className="bg-(--primary-500) hover:bg-(--primary-600) text-white rounded-lg px-4 py-2 font-semibold transition"
