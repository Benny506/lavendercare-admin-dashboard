...
function ThirdPartyProducts() {
    ...
    const { fetchThirdPartyProducts } = useApiReqs()

    const products = useSelector(state => getAdminState(state).thirdPartyProducts)
    ...
    return (
        <div className="w-full py-6">
            ...
            <div className="flex md:flex-row flex-col justify-between mb-3 gap-4 items-center">
                <h2 className="text-2xl font-semibold">Third Party Products</h2>
            </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="py-4 px-3 text-left font-medium">Approved</th>
                                    ...
                                    pageItems.map((p, idx) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="py-4 px-3">{p?.is_approved ? <BsCheck size={16} color="#703DCB" /> : <MdOutlineCancel size={16} color="red" />}</td>
