...
const summaryStats = [
  { label: "Total Screening", value: "456" },
  { label: "Mild Screening", value: "89" },
  { label: "Moderate Screening", value: "89" },
  { label: "Severe Screening", value: "89" },
];
  ...
  return (
    <div className="pt-6 w-full min-h-screen mb-8">
     ...
     <div className="flex pb-4 items-center gap-1">
      ...
      {/* sales title */}
      <div className="flex flex-col md:flex-row md:items-center sm:mb-4 mb-6 md:justify-between">
        <h2 className="text-lg sm:text-xl font-bold">
          Sales & Revenue Reports
        </h2>

        {/* Controls */}
        <div className="flex py-4 md:py-0 sm:flex-row gap-2 sm:gap-2 md:items-center md:justify-end">
        ...
        <div className="flex gap-2 text-[12px] w-max rounded-sm border-[#DEE0E3] border">
            <p className="py-1 w-max text-white bg-(--primary-500) rounded-l-sm px-2">PHQ-9</p>
            <p className="py-1 w-max pr-2 border-r-[#DEE0E3] border-r">EPDS</p>
            <p className="py-1 w-max pr-2">GAD-7</p>
        </div>
      </div>
      ...
      {/* Charts Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 rounded-[16px] gap-4 mb-6">
        <div className="bg-white rounded-xl border-[#DEE0E3] border p-4 flex flex-col">
 
          {/* Chart Placeholder */}
          <div className="w-full h-32 sm:h-60 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400">
            [Line Chart]
          </div>
        </div>
        <div className="bg-white rounded-xl border-[#DEE0E3] border p-4 flex flex-col">
...
export default ScreeningOutcomes;
