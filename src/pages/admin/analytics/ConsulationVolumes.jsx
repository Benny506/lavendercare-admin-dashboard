...
const summaryStats = [
  { label: "Total Booking", value: "456" },
  { label: "Average per Doctor", value: "89" },
  { label: "Completed Consulation", value: "5,678" },
];
     ...
     <div className="flex pb-4 items-center gap-1">
      ...
      <div className="grid grid-cols-1 bg-white md:grid-cols-2 p-4 rounded-[16px] gap-4 mb-6">
        <div className="bg-white rounded-xl border-[#DEE0E3] border p-4 flex flex-col">
          <div className="text-xs text-gray-400 mb-2">New Bookings & Consultations</div>
        ...
        <div className="bg-white rounded-xl border-[#DEE0E3] border p-4 flex flex-col">
          <div className="text-xs text-gray-400 mb-2">Daily Volumes by Type</div>
...
export default ConsulationVolumes;
